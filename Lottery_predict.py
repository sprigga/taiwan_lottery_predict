...
根據大樂透半年的中獎資料，分析並推薦四組彩券號碼（包含特別號）。

**重要：你的回覆必須只包含一個合法的 JSON 陣列，不得有任何其他文字或說明（可用 ```json ``` 包裝）。**

JSON 格式如下（共4個元素）：
```json
[
  {{"type": "冷門號碼組合", "regular_numbers": [n1, n2, n3, n4, n5, n6], "special_number": n, "reason": "選號理由"}},
  {{"type": "熱門號碼組合", "regular_numbers": [n1, n2, n3, n4, n5, n6], "special_number": n, "reason": "選號理由"}},
  {{"type": "熱門 + 冷門 混合號碼組合", "regular_numbers": [n1, n2, n3, n4, n5, n6], "special_number": n, "reason": "選號理由"}},
  {{"type": "均衡組合", "regular_numbers": [n1, n2, n3, n4, n5, n6], "special_number": n, "reason": "選號理由"}}
]
```
"""
